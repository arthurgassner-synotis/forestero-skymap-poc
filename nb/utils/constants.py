...
SENTINEL_BANDS = ["blue", "green", "red", "rededge1", "nir", "swir22", "scl"]
...
SENTINEL_ASHANTI_2026_SCENE_IDS_FILEPATH = SILVER_FOLDERPATH / "ashanti_2026_scene_ids.joblib"
SENTINEL_GH_SCENES_FILEPATH = SILVER_FOLDERPATH / "gh_2020_scenes.joblib"

FORESTERO_SITES_PKL_FILEPATH = SILVER_FOLDERPATH / "sites.pkl"
